...
The $C_\ell^{BB}$ from CAMB has power only up to $\ell = 600$, however, givent that the primordial BB signal is suppressed on scales smaller than the horizon scale at decoupling this should not matter in practice.
